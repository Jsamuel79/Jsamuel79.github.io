...
export default function DockerPage() {
  ...
  return (
    <main className="relative min-h-screen bg-[#1D272B] text-white overflow-hidden font-mono">
      {/* 1. Le Masque de couleur (Bleu Docker) qui s'ouvre */}
      <div 
      ...
      <div className="p-10 md:p-24">
        ...
        {/* NAVBAR INTER-SKILLS ADAPTÉE */}
        <nav className="fixed bottom-10 left-1/2 -translate-x-1/2 flex gap-10 bg-white/10 p-4 rounded-md border border-white/20 backdrop-blur-xl">
           ...
           <Link href="/" className="bg-blue-500 px-4 py-1 rounded text-black font-bold uppercase text-[9px]">Vaisseau</Link>
        </nav>
      </div>
    </main>
  )
